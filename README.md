...
**[⬇️ Download ClaudeMeter.dmg](https://github.com/EmreYigitAlparslan/claude-meter/releases/latest)** — drag to Applications, done.

> **First launch:** macOS may block the app since it's not notarized. Go to **System Settings → Privacy & Security** and click **Open Anyway**. This is a one-time step.
